...
def oAuth_example():
    ...
    #smart_contract_address = "0xA43fe16908251ee70EF74718545e4FE6C5cCEc9f"
...
# # Your existing function to check address type
# def check_address_type(address):
#     infura_url = 'https://mainnet.infura.io/v3/8c803623898743dc9747fe8e33694d5b'
#     w3 = Web3(Web3.HTTPProvider(infura_url))
#     checksum_address = w3.to_checksum_address(address)
...
# # Modified function to return data instead of showing plots
# def oAuth_example():
#     url = "https://oauth2.bitquery.io/oauth2/token"
#     payload = 'grant_type=client_credentials&client_id=2ce4e182-5cc8-4d02-b47d-3f550afa6cdb&client_secret=BMzqn0VSq1Y-rN-33W5lLn1a02&scope=api'
#     headers = {'Content-Type': 'application/x-www-form-urlencoded'}
...
#     url_graphql = "https://streaming.bitquery.io/graphql"
#     headers_graphql = {'Content-Type': 'application/json', 'Authorization': f'Bearer {access_token}'}
...
# holders_data, total_supply = oAuth_example()
...
# # Update layout
# fig.update_layout(
#     title={'text': 'Top 100 LPs position on USD0-USD0++ on Curve - Ethereum', 'x': 0.5, 'xanchor': 'center'},
#     margin=dict(t=50, l=25, r=25, b=25)
# )

# # Layout of the Dash app
# app.layout = html.Div([
#     html.H1("Token Holders Visualization", style={'textAlign': 'center'}),
